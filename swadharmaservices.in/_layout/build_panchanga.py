...
the ones the UI reasons about.
    ...
    python _layout/build_panchanga.py            # writes panchanga.json
...
def main() -> int:
    ...
    if check:
        if current != text:
            ...
            return 1
        print("panchanga.json up to date.")
        return 0

    if current == text:
        print("panchanga.json unchanged.")
        return 0
    ...
    meta = data["meta"]
    print(
        f"Wrote panchanga.json — {meta['days']} days {meta['from']} to {meta['to']}, "
